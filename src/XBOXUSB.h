...
public:
	...
	/**
	 * Begin for the XBOXUSB class.
	 * @param  pUsb   Pointer to USB class instance.
	 */
	void Begin(USBHost* pUsb);
	...
	uint32_t getButtonState() { return ButtonState; };
	/**@}*/
...
protected:
	...
	//HIDBoot<HID_PROTOCOL_KEYBOARD> host;
private:
	/**
	...
	uint8_t m_readBuffer[EP_MAXPKTSIZE]; // General purpose buffer for input data
	...
	/* Private commands */
	void XboxCommand(uint8_t* data, uint32_t nbytes);
};
#endif
